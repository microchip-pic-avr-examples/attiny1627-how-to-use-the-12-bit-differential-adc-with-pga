pipeline {
	...
	environment {		
		GITHUB_URL ='https://github.com/microchip-pic-avr-examples/attiny1627-how-to-use-the-12-bit-differential-adc-with-pga.git'
		BITBUCKET_URL = 'https://bitbucket.microchip.com/scm/ebe/attiny1627-how-to-use-the-12-bit-differential-adc-with-pga.git'
